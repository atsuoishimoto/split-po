...
class TestRoundtrip:
    ...
    def test_large_file_roundtrip_100_entries(self, tmp_path):
        ...
        # Expected number of files: 250 entries / 100 per file = 3 files
...
"""
        ...
        assert len(split_files) == 1000
        
        # Check that numbering uses 4 digits (since we have 1000 files)
        assert split_files[0].endswith("huge_part_0000.po")
        assert split_files[999].endswith("huge_part_0999.po")
